...
====================================================================
FINALIDAD:
  Que un solo cliente no pueda vaciarte la cuenta del proveedor. Cada consulta
  al asistente cuesta dinero real; sin freno, un bucle mal escrito (o un bot
  raspando el catálogo) convierte tu factura en el incidente. El guardrail de
  entrada filtra QUÉ se pregunta; esto limita CUÁNTO.
